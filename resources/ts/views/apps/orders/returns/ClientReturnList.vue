...
watch([searchQueryDebounced, selectedStatus, selectedApprovalStatus, selectedClient], () => {
  fetchReturns()
})
      ...
      <VCard :title="`Client Return Details - #${selectedReturn?.id}`">
        <VCardText>
          ...
          <FinancialOrdersDetailTable
            ...
            :show-actions="can('client-return.update' as any, 'all' as any)"
