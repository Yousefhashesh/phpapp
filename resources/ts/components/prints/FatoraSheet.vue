...
<template>
  ...
  <section class="label-amounts">
      <div class="label-amount-box label-amount-box--main">
       <span class="label-amount-box__key">الوجهة الكاملة</span>
       <span class="label-amount-box__key__val">{{ fullAddress }}</span>
    </div>
...
.label-amount-box--main .label-amount-box__val {
  font-size: 1.2rem;
}
